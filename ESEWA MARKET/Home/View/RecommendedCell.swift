...
class RecommendedCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            recommendedImageView.leadingAnchor.constraint(equalTo: self.contentView.leadingAnchor, constant: 0),
            recommendedImageView.trailingAnchor.constraint(equalTo: self.contentView.trailingAnchor, constant: 0),
            recommendedImageView.heightAnchor.constraint(equalToConstant: 160),
            
            containerView.topAnchor.constraint(equalTo: recommendedImageView.bottomAnchor, constant: 16),
